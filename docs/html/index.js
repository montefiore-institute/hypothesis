...
"url":0,
"doc":"Number of available logical processor cores. The variable will be initialized when :mod: hypothesis is loaded for the first time."
},
{
"ref":"hypothesis.workers",
"url":0,
"doc":"Default number of parallel workers in :mod: hypothesis ."
},
{
...
"url":1,
"doc":"Benchmark problems for simulation-based inference methodologies."
},
{
...
{
"ref":"hypothesis.benchmark.weinberg.simulator.Simulator",
"url":3,
"doc":"This is a simulation of high energy particle collisions $e^+e^- \\to \\mu^+ \\mu^-$. The angular distributions of the particles can be used to measure the Weinberg angle in the standard model of particle physics. If you get a PhD in particle physics, you may learn how to calculate these distributions and interpret those equations to learn that an effective way to infer this parameter is to run your particle accelerator with a beam energy just above or below half the $Z$ boson mass (i.e. the optimal $\\phi$ is just above and below 45 GeV). Adapted from https: github.com/cranmer/active_sciencing/blob/master/demo_weinberg.ipynb Original implementation by Lucas Heinrich and Kyle Cranmer.  code-block python from hypothesis.benchmark.weinberg import Prior from hypothesis.benchmark.weinberg import Simulator prior = Prior() simulator = Simulator() inputs = prior.sample 10,  Draw 10 samples from the prior outputs = simulator(inputs)  You can also batch with respect to the experimental configurations from hypothesis.benchmark.weinberg import PriorExperiment prior_experiment = PriorExperiment() beam_energies = prior_experiment.sample 10, outputs = simulator(inputs, beam_energies) Initializes internal Module state, shared by both nn.Module and ScriptModule."
},
{
"ref":"hypothesis.benchmark.weinberg.simulator.Simulator.dump_patches",
"url":3,
"doc":""
},
{
"ref":"hypothesis.benchmark.weinberg.simulator.Simulator.training",
"url":3,
"doc":""
},
{
"ref":"hypothesis.benchmark.weinberg.simulator.Simulator.MZ",
"url":3,
"doc":""
},
{
"ref":"hypothesis.benchmark.weinberg.simulator.Simulator.GFNom",
"url":3,
"doc":""
},
{
"ref":"hypothesis.benchmark.weinberg.simulator.Simulator.forward",
"url":3,
...
{
"ref":"hypothesis.benchmark.weinberg.simulator.Simulator.terminate",
"url":4,
...
"url":6,
"doc":"Stochastic Spatial Susceptible Infected Recovered benchmark"
},
{
...
{
"ref":"hypothesis.benchmark.spatialsir.simulator.Simulator",
"url":7,
"doc":"Base simulator class. A simulator defines the forward model. Example usage of a potential simulator implementation:  code-block python simulator = MySimulator() inputs = prior.sample 10,  Draw 10 samples from the prior. outputs = simulator(inputs)  note The  inputs and  outputs variable name in most simulator denote their position with respect to the simulation model.  inputs are typically free parameters of the simulation model which sample (or produce deterministically)  outputs .  note Although it is possibly to supply a batch of inputs, it should be noted that these are currently  not parallelized. Initializes internal Module state, shared by both nn.Module and ScriptModule."
},
{
"ref":"hypothesis.benchmark.spatialsir.simulator.Simulator.dump_patches",
"url":7,
"doc":""
},
{
"ref":"hypothesis.benchmark.spatialsir.simulator.Simulator.training",
"url":7,
"doc":""
},
{
"ref":"hypothesis.benchmark.spatialsir.simulator.Simulator.simulate",
"url":7,
"doc":"",
"func":1
},
{
"ref":"hypothesis.benchmark.spatialsir.simulator.Simulator.forward",
"url":7,
"doc":"Defines the computation of the forward model at every call.  note Should be overridden by all subclasses.",
"func":1
},
{
"ref":"hypothesis.benchmark.spatialsir.simulator.Simulator.terminate",
"url":4,
"doc":"Terminates the simulator and cleans up possible contexts.  note Should be overridden by subclasses with a simulator state requiring graceful exits.",
"func":1
},
...
{
"ref":"hypothesis.benchmark.tractable.simulator.Simulator",
"url":10,
"doc":"Base simulator class. A simulator defines the forward model. Example usage of a potential simulator implementation:  code-block python simulator = MySimulator() inputs = prior.sample 10,  Draw 10 samples from the prior. outputs = simulator(inputs)  note The  inputs and  outputs variable name in most simulator denote their position with respect to the simulation model.  inputs are typically free parameters of the simulation model which sample (or produce deterministically)  outputs .  note Although it is possibly to supply a batch of inputs, it should be noted that these are currently  not parallelized. Simulation model associated with the tractable benchmark."
},
{
"ref":"hypothesis.benchmark.tractable.simulator.Simulator.dump_patches",
"url":10,
"doc":""
},
{
"ref":"hypothesis.benchmark.tractable.simulator.Simulator.training",
"url":10,
"doc":""
},
{
"ref":"hypothesis.benchmark.tractable.simulator.Simulator.forward",
"url":10,
"doc":"Defines the computation of the forward model at every call.  note Should be overridden by all subclasses.",
"func":1
},
{
"ref":"hypothesis.benchmark.tractable.simulator.Simulator.terminate",
"url":4,
"doc":"Terminates the simulator and cleans up possible contexts.  note Should be overridden by subclasses with a simulator state requiring graceful exits.",
"func":1
},
...
"url":12,
"doc":"Simulation model of the M/G/1 queuing model. This model describes a queuing system of continuously arriving jobs by a single server. The time it takes to process every job is uniformly distributed in the interval :math: [\\theta_1, \\theta_2] . The arrival between two consecutive jobs is exponentially distributed according to the rate :math: \\theta_3 . That is, for every job :math: i we have the processing time :math: p_i , an arrival time :math: a_i and the time :math: l_i at which the job left the queue."
},
{
...
{
"ref":"hypothesis.benchmark.mg1.simulator.Simulator",
"url":13,
"doc":"Base simulator class. A simulator defines the forward model. Example usage of a potential simulator implementation:  code-block python simulator = MySimulator() inputs = prior.sample 10,  Draw 10 samples from the prior. outputs = simulator(inputs)  note The  inputs and  outputs variable name in most simulator denote their position with respect to the simulation model.  inputs are typically free parameters of the simulation model which sample (or produce deterministically)  outputs .  note Although it is possibly to supply a batch of inputs, it should be noted that these are currently  not parallelized. Initializes internal Module state, shared by both nn.Module and ScriptModule."
},
{
"ref":"hypothesis.benchmark.mg1.simulator.Simulator.dump_patches",
"url":13,
"doc":""
},
{
"ref":"hypothesis.benchmark.mg1.simulator.Simulator.training",
"url":13,
"doc":""
},
{
"ref":"hypothesis.benchmark.mg1.simulator.Simulator.forward",
"url":13,
"doc":"Defines the computation of the forward model at every call.  note Should be overridden by all subclasses.",
"func":1
},
{
"ref":"hypothesis.benchmark.mg1.simulator.Simulator.terminate",
"url":4,
"doc":"Terminates the simulator and cleans up possible contexts.  note Should be overridden by subclasses with a simulator state requiring graceful exits.",
"func":1
},
...
"url":34,
"doc":":mod: hypothesis.simulation is a submodule containing the base simulator architecture and utilities to execute efficient simulations. Every forward model requires to be wrapped in a class which inherits from :class: hypothesis.simulation.BaseSimulator ."
},
{
...
{
"ref":"hypothesis.simulation.base.BaseSimulator.dump_patches",
"url":4,
"doc":""
},
{
"ref":"hypothesis.simulation.base.BaseSimulator.training",
"url":4,
"doc":""
},
{
...
"ref":"hypothesis.cli",
"url":35,
"doc":"Console script for hypothesis."
},
{
...
"ref":"hypothesis.nn",
"url":57,
"doc":":mod: hypothesis.nn is a submodule containing neural network utilities."
},
{

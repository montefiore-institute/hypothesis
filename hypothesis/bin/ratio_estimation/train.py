...
def parse_arguments():
    ...
    # General settings
    parser.add_argument("--criterion", type=str, default="hypothesis.nn.ratio_estimation.BalancedCriterion", help="Optimization criterion (default: hypothesis.nn.ratio_estimation.BalancedCriterion).")

"""General training script for Amortised Posterior Estimation with Normalizing Flows."""
...
from hypothesis.nn.amortized_ratio_estimation import FlowPosteriorCriterion
...
def main(arguments):
    ...
    if arguments.conservativeness > 0.0:
        ...
        criterion = FlowPosteriorCriterion(

...
class NeuromodulatedConditionalResNetRatioEstimator(ResNet, BaseNeuromodulatedConditionalRatioEstimator):
    ...
    def __init__(self,
        ...
        ResNet.__init__(self,
            ...
            trunk_dropout=trunk_dropout,
            ys_transform=None)
        BaseNeuromodulatedConditionalRatioEstimator.__init__(self)
